export const projects = [
  {
    ...
    description:
      "This product is designed for City of Thunder Bays’ Bus Transit system to simulate the electrification of its current system. They will be able to view the impact on the schedule, estimation of energy consumption and fuel requirements, environmental impact and financial impact after the introduction.",
  ...
  },
  {
    ...
    description:
      "This project is developed for sake of improving my own skills in C++ , multithreading, computer vision and software design.",
